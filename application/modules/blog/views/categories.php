      ...
      <div class="panel-body">
         <div class="row">
            <div class="col-md-12">
               ...
               <form id="add_cat_validate" action="<?= base_url('blog/BlogCategory/add') ?>" method="post" class="form-horizontal row-border">
                  <div class="form-group">
                     <label class="col-sm-2 control-label text-success">Add Category</label>
                     <div class="col-sm-4">
               ...
               <table class="table table-hover">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="<?php bs() ?>blog/BlogCategory/delete/<?php echo $category->id ?>" title="">
                     ...
                     <?php else: ?>
                        ...
                        <tr>
                           <td>
                              <p><font color="red" size="4"><b>Categories Not Added Yet</b></font></p> 
                           </td>
                        </tr>
