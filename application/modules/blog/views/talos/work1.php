				...
				<div class="section">
						...
						<div class="twelve columns">
							<div id="portfolio-filter">
								<ul id="filter">
									...
									<li class="tipped" data-title="3 projects" data-tipper-options='{"direction":"top","follow":"true"}'><a href="#" data-filter=".motion" title="">motion</a></li>
								</ul>
							</div>
						</div>
					</div>	
					...
					<div id="projects-grid" class="full-work-width">
						<a class="tipped" href="project.html" data-title="branding" data-tipper-options='{"direction":"top","follow":"true"}'>
							<div class="portfolio-box-1 three-col-por branding">
								<div class="mask"></div>
						...
						<a class="tipped" href="project.html" data-title="photo" data-tipper-options='{"direction":"top","follow":"true"}'>
							<div class="portfolio-box-1 three-col-por photo">
								<div class="mask"></div>
						...
						<a class="tipped" href="project.html" data-title="motion" data-tipper-options='{"direction":"top","follow":"true"}'>
							<div class="portfolio-box-1 three-col-por motion">
								<div class="mask"></div>
...
<script type="text/javascript" src="<?php bs() ?>public/blog_assets/js/custom-work1.js"></script>    
<!-- End Document
================================================== -->
</body>
</html>